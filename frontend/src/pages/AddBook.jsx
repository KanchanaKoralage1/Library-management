...
function AddBook() {
  ...
  const handleSubmit=async (e)=>{
    ...
    if(!image || !title || !Subtitle || !author || !link){
  ...
  return (
    ...
    <div className='min-h-screen text-[#252422] bg-[#f3f5f0] px-4 md:px-14 pb-14'>
      ...
      <h1 className='text-center font-semibold pt-8 md:text-4xl w-full max-w-xl mx-auto'>ADD NEW BOOK</h1>
      ...
      <form action="" className='flex flex-col justify-center items-center w-full max-w-xl mx-auto space-y-8 mt-12' onSubmit={handleSubmit}>
        ...
        <button className='w-full bg-[#00BFFF] text-[#FFFCF2] py-2 font-medium rounded-lg' type='submit' >{isLoading ? "Please wait...." : "Add Book"}</button>
