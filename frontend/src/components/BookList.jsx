...
const BookList = () => {
  ...
  return (
    ...
    <div className='text-[#242522] bg-[#f3f5f0] px-4 md:px-12 pb-20'>

      <h1 className='py-8 text-xl md:text-2xl lg:text-4xl w-full mx-auto max-w-6xl font-semibold'>Current Book List</h1>
